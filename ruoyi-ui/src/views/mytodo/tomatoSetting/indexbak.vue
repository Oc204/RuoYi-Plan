  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="番茄时长(最大为60分钟)" prop="tomatoTime">
        <el-input
          v-model="queryParams.tomatoTime"
          placeholder="请输入番茄时长(最大为60分钟)"
          clearable
          size="small"
      ...
      <el-form-item label="番茄钟类别：番茄时长\短时休息\长时休息" prop="flag">
        <el-input
          ...
          placeholder="请输入番茄钟类别：番茄时长\短时休息\长时休息"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="settingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="番茄时长(最大为60分钟)" align="center" prop="tomatoTime" />
      <el-table-column label="用户id" align="center" prop="userId" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="是否激活" align="center" prop="active" />
      <el-table-column label="番茄钟类别：番茄时长\短时休息\长时休息" align="center" prop="flag" />
...
<script>
import { listSetting, getSetting, delSetting, addSetting, updateSetting } from "@/api/mytodo/tomatoSetting";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除番茄编号为"' + ids + '"的数据项？').then(function() {
